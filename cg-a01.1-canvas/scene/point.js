...
define(["util", "vec2", "Scene"],
    (function (util, vec2, Scene) {
        ...
        var Point = function (mp, r, style) {

            console.log("creating circle with middlepoint [" + mp[0] + "," + mp[1] + "] and " +
                "radius" + r + ".");
        ...
        Point.prototype.draw = function (context) {
            ...
            context.arc(this.mp[0], this.mp[1], this.r, 0, 2 * Math.PI,true);
